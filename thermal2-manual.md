...
Note that isotopic_disorder and casimir_scattering are properly implemented in for both SMA and CGP calculations.
...
You can than plot the resulting file with a gnuplot command like this (you will have to tune the pointsize and of course select the correct band to plot):
